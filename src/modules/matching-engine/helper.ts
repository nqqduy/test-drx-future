...
export function convertDateFields<T>(object: T, entity: Record<string, unknown>): T {
  if (entity.createdAt) {
...
export function convertFundingHistoriesDateFields<T>(object: T, entity: Record<string, unknown>): T {
...
export function convertDateFieldsForOrders<T>(object: T, entity: Record<string, unknown>): T {
  if (entity.createdAt) {
    entity.createdAt = new Date(entity.createdAt as number);
  } else {
    entity.createdAt = new Date();
