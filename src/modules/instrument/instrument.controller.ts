...
export class InstrumentController {
  ...
  @Get()
  async getAllInstruments(@Query() query: GetInstrumentDto): Promise<ResponseDto<InstrumentEntity[]>> {
    return {
  ...
  async createMarketFeeByInstrument(
    @Body() createMarketFeeDto: CreateMarketFeeDto,
  ): Promise<ResponseDto<MarketFeeEntity>> {
    return {
  ...
  async updateMarketFeeByInstrument(
    @Body() updateMarketFeeDto: UpdateMarketFeeDto,
  ): Promise<ResponseDto<MarketFeeEntity>> {
    return {
