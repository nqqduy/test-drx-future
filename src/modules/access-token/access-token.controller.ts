...
export class AccessTokenController {
  ...
  async addAccessToken(@Body() body: AccessTokenDto, @UserID() userId: number): Promise<ResponseDto<AccessToken>> {
    return {
  ...
  @Delete('/')
  @UseGuards(JwtTokenGuard)
  async removeAccessToken(@Body() body: AccessTokenDto, @UserID() userId: number) {
    return {
