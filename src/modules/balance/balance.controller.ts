...
export class BalanceController {
  ...
  async getAllAccountByOwner(@UserID() userId: number): Promise<ResponseDto<AccountEntity[]>> {
    return {
  ...
  @Get('/infor')
  @UseGuards(JwtAuthGuard)
  async getBalanceInfor(@UserID() userId: number, @Query() query: GetInforBalanceDto) {
