...
export class LeverageMarginController {
  ...
  @Get()
  async getAllLeverageMargin(@Query('symbol') symbol: string): Promise<LeverageMarginEntity[]> {
  ...
  async upsertLeverageMargin(@Body() leverageMarginDto: LeverageMarginDto): Promise<LeverageMarginEntity> {
