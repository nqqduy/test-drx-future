...
import { KEY_CACHE_HEALTHCHECK_GET_FUNDING, KEY_CACHE_HEALTHCHECK_PAY_FUNDING } from '../funding/funding.const';
...
export class MetricsService {
  ...
  constructor(@Inject(CACHE_MANAGER) private cacheManager: Cache, private readonly redisService: RedisService) {
