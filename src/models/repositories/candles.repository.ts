...
export class CandlesRepository extends Repository<CandlesEntity> {
  async getLastCandleBefore(symbol: string, time: number): Promise<CandlesEntity | undefined> {
    return this.findOne({
      where: {
        symbol,
  ...
  async getCandlesInRange(symbol: string, time: number, resolution: number): Promise<CandlesEntity[]> {
    return this.find({
      where: {
        symbol,
        resolution: RESOLUTION_MINUTE,
  ...
  async getLastCandleOfResolution(symbol: string, resolution: number): Promise<CandlesEntity | undefined> {
    console.log(".............................................................");
    console.log(symbol)
    return this.findOne({
      where: {
